...
[here][prism-react-renderer-themes]. By default, it uses the `duotoneDark` theme. You want
to import the specific theme and then pass it as the value for the `theme` prop on `Highlight`:
