...
I am gonna share a bit about how I have integrated with `prism-react-renderer` and keep styles the
styles I was using back with `gatsby-remark-prismjs`. As I slowly migrate my blog, I wanted to make sure that 
I kept a good record as far as what tools I have been using. One of the most important things for me 
...
1. how to use other preset themes
2. how to reuse the ones you had with `gatsby-remark-prismjs`. 
